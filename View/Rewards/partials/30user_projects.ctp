                    ...
                    <div class="row border-sec">
                        ...
                        <div class="colume-3">
                        	...
                        	if(isset($project_users) && !empty($project_users)) { ?>
                				...
                				<?php
                        		foreach ($project_users as $key => $userId) {
	                    			...
	                    			?>
		                    			<div class="item" data-total="<?php echo $total_amount; ?>">
		                    				<img class="user_popover" data-user="<?php echo $userId; ?>" src="<?php echo $user_chat_popover['user_image']; ?>" data-content="<div class=''><p><?php echo htmlentities($user_chat_popover['user_name'],ENT_QUOTES); ?></p><p><?php echo htmlentities($user_chat_popover['job_title'],ENT_QUOTES); ?></p><?php echo $user_chat_popover['html']; ?></div>" >
				...
				<div class="ov-project-status">
				    ...
				    <div class="ov-project-col padd15">
				        ...
				        <div class="ov-project-status-in">
				            ...
				            <div class="ov-status-info accelerator-popover" <?php if($project_accelerate){ ?> data-content="<div class='com-user' style='font-size: 12px;'><?php echo $project_accelerate['RewardAccelerate']['reason']; ?></div>" <?php } ?> style="margin-top: 16px;">
