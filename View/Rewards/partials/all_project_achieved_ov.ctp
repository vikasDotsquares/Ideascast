...
if(isset($projects) && !empty($projects)) {
	foreach ($projects as $key => $p_id) {
		...
		$projectUsers = $this->TaskCenter->userByProject($key);
...
<div class="modal-header">
    ...
    <h3 class="modal-title" id="createModelLabel">All Projects - OV Achieved</h3>
</div>
    ...
    <div class="col-sm-6 nopadding-left" style="min-height: 34px;">
	   	<div class="project-ov-input-wrap">
	  		<div class="input-group1 project-ov-input-group">
	            ...
	            ?>
	         	<!-- <span class="input-group-addon bg-red project-ov-clear-type" style="border-color: #dd4b39;"><i class="fa fa-times"></i></span> -->
			</div>
		</div>
	</div>
	<!-- <div class="col-sm-8 text-right nopadding-right" style="font-size: 12px;line-height: 27px;">[Member totals do not include Accelerations]</div> -->
