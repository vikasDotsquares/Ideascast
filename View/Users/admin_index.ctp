		...
		<div class="row">
			<div class="col-xs-12">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Internal IdeasCast Users</li>
				</ol>
				<h3>Internal IdeasCast Users (<?php echo $count; ?>)</h3>
				</div>
					...
					<div class="box-header">
						<h3 class="box-title">
							<small>Per Page Records</small> </h3>
								<div class="margintop">
									<div class="col-lg-1 ">
										<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'users', 'action'=>'index'), 'type' => 'file', 'class' => 'form-horizontal form-bordered', 'id' => 'per_page_show_form' )); ?>
										<?php 
						...
						<div class="<?php echo $class; ?> search" id="collapseExample">
							<div class="well">
								<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'users', 'action'=>'index'), 'type' => 'POST', 'class' => 'form-horizontal form-bordered', 'id' => 'search_page_show_form')); ?>
									<div class="modal-body">
										<div class="form-group">
											...
											<div class="col-lg-3">
													 ...
													 <?php echo $this->Form->input('UserDetail.country_id', array('options' => $this->Common->getCountryList(),'selected'=>$country,  'empty' => 'Select Country', 'label' => false, 'div' => false,  'onchange' => 'selectCity(this.options[this.selectedIndex].value)','class' => 'form-control')); ?>								  				  
												
											</div>
											
											<div class="col-lg-12" style="text-align:right;margin:20px 0 0 0">
												<button type="submit" class="searchbtn btn btn-success">Go</button>
												<a class="btn btn-primary searchbtn" href="<?php echo SITEURL; ?>sitepanel/users/user_resetfilter" >Close</a>
											</div>												
										</div>
									</div>
									</form>
						...
						<table id="example2" class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th><?php echo $this->Paginator->sort('UserDetail.institution_id',__("Institution"));?></th>
							...
							<tbody>
								...
								<tr>
									...
									<td><?php if(empty($user['UserDetail']['institution_id'])){ echo "N/A"; }else{ $det = $this->Common->userDetail($user['UserDetail']['institution_id']); 
