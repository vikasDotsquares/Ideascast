<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<?php 
			if($this->data['User']['role_id']==2){ echo "View User"; 
			}else if($this->data['User']['role_id']==3){ echo "View Author";
			}else if($this->data['User']['role_id']==4){ echo "View Institution"; } 
			?>
			</h4>
		</div>
		<div class="modal-body">
			...
			<?php }else { ?>
			<div class="form-group">
			<label  class="control-label col-md-4 col-xs-6">First Name:</label>
			<p class="control-label col-md-8 col-xs-6"><?php  echo $this->data['UserDetail']['first_name']; 
			//echo $this->Form->input('UserDetail.first_name', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></p>
			</div>
			...
			<div class="form-group">
			  <label class="control-label col-md-4 col-xs-6">Last Name:</label>
			  
				<p class="control-label col-md-8 col-xs-6"><?php echo $this->data['UserDetail']['last_name']; //echo $this->Form->input('UserDetail.last_name', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></p>
			...
			<div class="form-group">
			  <label  class="control-label col-md-4 col-xs-6">Organization Name:</label>
