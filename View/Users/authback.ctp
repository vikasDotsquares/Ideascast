...
include_once DOC_ROOT.'google-drive/vendor/autoload.php';
include_once DOC_ROOT."google-drive/examples/templates/base.php";
...
<?php elseif($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
  <div class="shortened">
    ...
    <p><a href="https://drive.google.com/open?id=<?php echo $result->id ?>" target="_blank"><?php echo $result->name ?></a></p>
  </div>
<?php else: ?>
  <form method="POST">
