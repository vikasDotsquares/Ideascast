	 ...
	 <div class="box-content">
		<div class="row">
			<div class="col-xs-12">
				...
				<h3>Organisations (<?php echo $count; ?>)</h3>
				</div>
					...
					<div class="box-header">
						<h3 class="box-title">
							<small>Per Page Records</small> </h3>
								<div class="margintop">
									<div class="col-lg-1 ">
										<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'users', 'action'=>'thirdparty_users'), 'type' => 'file', 'class' => 'form-horizontal form-bordered', 'id' => 'per_page_show_form' )); ?>
										<?php 
						...
						<div class="pull-right padright">
							...
							<?php 
								$add = SITEURL."sitepanel/users/thirdparty_add/"; 
							?>
						...
						<div class="<?php echo $class; ?> search" id="collapseExample">
							<div class="well">
								<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'users', 'action'=>'thirdparty_users'), 'type' => 'POST', 'class' => 'form-horizontal form-bordered', 'id' => 'search_page_show_form')); ?>
