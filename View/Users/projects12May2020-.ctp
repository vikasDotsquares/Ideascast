...
<style>
   ...
   /* top: 35%;
	...
	.bootstrap-select:not([class*="span"]):not([class*="col-"]):not([class*="form-control"]):not(.input-group-btn){ width: 320px;}
    
    @media (min-width:1340px) and (max-width:1400px) {
        .bootstrap-select:not([class*="span"]):not([class*="col-"]):not([class*="form-control"]):not(.input-group-btn){ width: 280px;}
    }
                   ...
                   <?php /*?> <div class="radio-family col-sm-12 col-md-12 col-lg-6 nopadding-left nomargin-left radio-family-left-unq"><?php */?>
                    ...
                    <div class="second_row show-resources-top-row">
						...
						<div class="box-tools col-sm-12 col-md-6 col-lg-6 box-tools-right-unq"><div class="my_p sect" >
								...
								echo $this->Form->input("project_id", array("id" => "my_project", "div" => false, "selected" => $project_id, "label" => false, "class" => "getWrkSpaces selectpicker", "data-style" => "aqua", "style" => "display: none;", "type" => "select", "options" => $allProjects,'empty'=>"Select Project"));
								} else {
                                    ?>
                        ...
                        <div class="box-tools col-sm-12 col-md-6 col-lg-6 box-tools-right-unq pull-right project-assets-sec-h">
                            ...
                            <label class="show-label">Asset Type </label>
                            ...
                            <div class="two-btn-ass">
                                <button type="button" id="multiple_element_type_submit" style="margin-right:4px" class="btn btn-sm btn-success">Apply Filter</button>
                            ...
                            <div class="search_div pull-right">
                                <input placeholder="Filter by Name…" class="search pull-left" id="search" style="margin: 0 12px ; width: 130px; padding: 4px; border: 1px solid #367fa9;">

                                <div id="sidetreecontrol" class="pull-left">
									 <a class="btn btn-primary btn-sm  searchbtn pull-right tipText" title="Collapse" href="?#" style="margin: 0 0 0 4px;"><i class="fa fa-compress"></i></a>
