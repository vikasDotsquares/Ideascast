		...
		<div class="row">
			<div class="col-xs-12">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo SITEURL; ?>sitepanel/users/institution_users"><!--<i class="fa fa-user"></i> -->Institutions</a></li>
					<li class="active">Users</li>
				</ol>
				<?php $det = $this->Common->userDetail($this->request->params['pass']['0']); ?>
				<h3>Users (<?php echo $count; ?>) at "institution (<?php echo trim($det['UserDetail']['first_name'])." ".trim($det['UserDetail']['last_name']); ?>)"</h3>
				</div>
					...
					<div class="box-header">
						<h3 class="box-title">
							<small>Per Page Records</small> </h3>
								<div class="margintop">
									<div class="col-lg-1 ">
										<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'users', 'action'=>'institution',$this->request->params['pass']['0']), 'type' => 'file', 'class' => 'form-horizontal form-bordered', 'id' => 'per_page_show_form' )); ?>
										<?php 
						...
						<!--	<a class="btn btn-primary searchbtn" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
							...
							<a class="btn btn-primary" href="<?php echo SITEURL ?>sitepanel/users/institution_users/">Back</a></h3>
						...
						<div class="<?php echo $class; ?> search" id="collapseExample">
							<div class="well">
								<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'users', 'action'=>'institution',$this->request->params['pass']['0']), 'type' => 'POST', 'class' => 'form-horizontal form-bordered', 'id' => 'search_page_show_form')); ?>
									<div class="modal-body">
										<div class="form-group">
											...
											<div class="col-lg-12" style="text-align:right; margin:20px 0 0 0">
												...
												<a class="btn btn-primary searchbtn" href="<?php echo SITEURL; ?>sitepanel/users/institution_resetfilter/<?php echo$this->request->params['pass']['0']; ?>" >Close</a>
											</div>												
										</div>
									</div>
									</form>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<?php 
										//$editURL = SITEURL."sitepanel/users/edit/".$user['User']['id']; 
										$editURL = SITEURL."sitepanel/users/edit/".$user['User']['id']."/institution/".$this->request->params['pass']['0']; 
										?>
