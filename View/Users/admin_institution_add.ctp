	...
	<div class="panel panel-primary">
	  <div class="panel-heading">
		...
		<div class="panel-body form-horizontal">
			...
			<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'users', 'action'=>'institution_add'),  'type' => 'file', 'class' => 'form-horizontal form-bordered', 'enctype' => 'multipart/form-data', 'id' => 'User')); ?>
