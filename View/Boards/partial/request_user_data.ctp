...
if(isset($data) && !empty($data)){
	...
	?>
      <div class="requests-col req-col-1">
         <div class="style-people-com">
            ...
            <div class="style-people-info">
               <span class="style-people-name"><?php echo $fullName;?> </span>
      ...
      <div class="requests-col req-col-4 requests-status">
				...
				?>
					<a style="opacity:1;cursor:default;"  class="request-sent tipText" href="#" title="Request: <?php echo $pbs_data['board_msg'] ?>"><i class="requestsent-icon"></i>&nbsp;<?php echo date('d M, Y', strtotime($pbs_data['created'])); ?></a>
					<a data-html="true" style="opacity:1;cursor:default;"  class="request-rejected tipText" data-reason="<?php echo $pbs_data['reason_id'];?>" href="#" title="Declined By: <?php echo ( isset($pbs_data['reasons']) && !empty($pbs_data['reasons']) ) ? $declined_by.'<br />'.$pbs_data['reasons'] : 'N/A';?>"><i class="inactivered"></i>&nbsp;<?php echo date('d M, Y', strtotime($pbs_data['updated'])); ?></a>
				<?php } ?>
      ...
      <div class="requests-col req-col-5 requests-actions">
			...
			<?php } if( $pbs_data['project_status'] == 2 ){ ?>
