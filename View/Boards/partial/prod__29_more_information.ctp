	...
	<div class="row d-flex-s opp-profile-popup allpopuptabs">
		...
		<div class="tab-content">
			 ...
			 <div class="form-group">
				...
				<div class="form-group">
				<label class="control-label">Project Schedule:</label>
				<div class="details-info">
				<?php echo date('d M, Y', strtotime($prj_data['start_date'])); ?> → <?php echo date('d M, Y', strtotime($prj_data['end_date'])); ?>
				</div>
			 </div>
				<div class="form-group">
				<label class="control-label">Project Objective:</label>
				<div class="details-info"><?php echo nl2br($prj_data['objective']);?></div>
			 </div>
...
<?php }
			...
			<li class="subjects-border-left">
				...
				<li class="subjects-border-left">No Sujects</li>
				<?php } ?>
				</ul>
				</div>
		  </div>
