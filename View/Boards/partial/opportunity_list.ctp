	...
	<div class="ssd-data-row">
		...
		<div class="loc-col opp-col opp-col-3">
		  	<div class="opp-work-info">
				<div class="opp-work-item"> <i class="opp-icon workspacesblack18"></i><?php echo ($total_workspaces == 1) ? $total_workspaces . ' Workspace' : number_format($total_workspaces,0) . ' Workspaces'; ?></div>
...
<div class="">
	<div class="no-summary-found">NO OPPORTUNITIES</div>
</div>
<?php } ?>
<style>
