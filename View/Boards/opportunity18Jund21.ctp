                    ...
                    <div class="box noborder ">
                        ...
                        <div class="box-body p0 clearfix" id="box_body">
                            <div class="tab-content">
								...
								<input type="hidden" name="paging_offset" id="paging_offset" value="1">
			                        <input type="hidden" name="paging_total" id="paging_total" value="20">
...
<div class="opportunities-request-lists list-request-wrapper list-wrapper" data-flag="false" style="overflow: auto; height:400px;" ></div>
...
<div class="requests-col-header">
   <div class="requests-col req-col-1">
      <div class="opp-heading">Popele <span> (0)</span>
         <span class="h-name-one sort_order tipText " data-coloumn="title" data-order="" title="Sort by Title" data-type="request">
         <i class="fa fa-sort" aria-hidden="true"></i>
         <i class="fa fa-sort-asc" aria-hidden="true"></i>
         <i class="fa fa-sort-desc" aria-hidden="true"></i>
         </span>
         <span class="sort_order tipText " data-coloumn="title" data-order="" title="Sort by Title" data-type="request">
         <i class="fa fa-sort" aria-hidden="true"></i>
         <i class="fa fa-sort-asc" aria-hidden="true"></i>
         <i class="fa fa-sort-desc" aria-hidden="true"></i>
         </span>
...
$(function(){
  /* TABS PAGINATION */
	...
	$( 'body' ).on( "click", ".project_request", function() {
		$that = $(this);
		
		$that.parents('.requests-project-info-inner').find('.requests-project-list').addClass('show').removeClass('hide');
