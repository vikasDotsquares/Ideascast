	...
	<div class="panel panel-primary">
	  <div class="panel-heading">
		...
		<div class="panel-body form-horizontal">
			...
			<?php echo $this->Form->create('Plan', array( 'url' => array('controller'=>'plans', 'action'=>'add'),  'type' => 'file', 'class' => 'form-horizontal form-bordered', 'enctype' => 'multipart/form-data', 'id' => 'Plan')); ?>
					...
					<div class="row">
						<div class="col-md-6">	
							<div class="form-group">
							  ...
							  <div class="col-lg-9">
									<input id="UserStatusADD" data-toggle="toggle" data-width="80" data-on="Active" data-off="Inactive" data-onstyle="success" data-offstyle="danger" class="on-off-btn" name="data[Plan][status]" checked  type="checkbox">
