...
<div class="table-responsive">	
		<table class="table table-hover table-bordered custom-table-border">
            ...
            <tbody>
				...
				<?php if(isset($disamount) && !empty($disamount) && ($disamount =='free') ){ 
				    echo $this->Form->create('Plan',array('url'=>'/plans/thanks_feature/'.$this->request->params['pass']['0'])); 
	...
	echo $this->Form->create('Plan',array('url'=>'/plans/plansummary_new/'.$this->request->params['pass']['0'], "id" => "editcoupon","class"=>"form-horizontal")); 
