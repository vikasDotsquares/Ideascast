<?php echo "yerdddddddddddddddddddddddddd";pr($blog); die; ?>
			...
			<div class="row">    
				<div class="col-sm-8">
					<div class="blog-details">
						...
						<div class="date-user"> By Ideascast, Posted Feb 8, 2017 </div>
						<div class="medialink">Media Icon</div>    
