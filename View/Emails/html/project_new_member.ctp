  ...
  <td bgcolor="#ffffff" style="padding: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	  <tbody>
		...
		<tr>
		  ...
		  A project has been shared with a new member.</td>		 
		</tr>
		<tr>
		  <td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tbody>				 
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Name:</strong> <?php if(isset($addedto)) echo $addedto; ?></td>
				</tr>
				<tr>
