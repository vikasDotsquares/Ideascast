	  ...
	  <tbody>
		...
		<tr>
		  <td align="left" style="padding:5px 0px 20px 0px; font-size: 18px; font-weight: bold;font-family:Arial, sans-serif;">
			You have received a reminder to vote.
		 </td>	 
		</tr>
		<tr>
		  <td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tbody>				 
				...
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Vote:</strong> <?php echo ucfirst(htmlentities($voteTitle,ENT_QUOTES)); ?>
				  </td>
				</tr> 				 				
			  </tbody>
			</table>
