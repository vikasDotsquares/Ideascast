		  ...
		  <td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tbody>				 
				...
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Risk:</strong> <?php echo ucfirst(htmlentities($risk_name,ENT_QUOTES));?></td>
				</tr>				
			  </tbody>
			</table>
			</td>
