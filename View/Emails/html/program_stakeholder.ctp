  ...
  <td bgcolor="#ffffff" style="padding: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	  <tbody>
		...
		<tr>
		  ...
		  You have been added as a program stakeholder.</td>
		</tr>
		<tr>
		  <td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tbody>
				...
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Created By:</strong> <?php echo  (htmlentities($sender,ENT_QUOTES));?></td>
				</tr>
			  </tbody>
			</table>
			</td>
