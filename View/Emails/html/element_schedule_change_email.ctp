	  ...
	  <tbody>
		...
		<tr>
		  <td align="left" style="padding:5px 0px 20px 0px; font-size: 18px; font-weight: bold;font-family:Arial, sans-serif;">
			The schedule of a task has changed.
		 </td>	 
		</tr>
		<tr>
		  <td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tbody>				 
				...
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Task:</strong> <?php echo ucfirst(htmlentities($element_name,ENT_QUOTES)); ?>
				  </td>
				</tr> 				 				
			  </tbody>
			</table>
