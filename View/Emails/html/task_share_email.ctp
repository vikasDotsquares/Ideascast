		...
		<tr>
		  <td align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tbody>
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Shared By:</strong> <?php echo ucfirst(htmlentities($name,ENT_QUOTES)); ?></td>
				</tr>
				<tr>
				...
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Workspace:</strong> <?php echo ucfirst(htmlentities($wspDetails['Workspace']['title'],ENT_QUOTES)); ?>
				  </td>
				</tr>
				<tr>
				  <td align="left" style="padding:3px 0px;font-family:Arial, sans-serif;"><strong> Task:</strong> <?php echo ucfirst(htmlentities($taskDetails['Element']['title'],ENT_QUOTES)); ?>
				  </td>
				</tr>
			  </tbody>
			</table>
