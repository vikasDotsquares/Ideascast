   ...
   <div class="panel panel-primary">
      <div class="panel-heading">
         <h3 class="panel-title">
            Edit <?php echo $this->data['Page']['name'];?>
      ...
      <div class="panel-body form-horizontal">
         <div class="row rownot">
            <div class="col-sm-12">
			   ...
			   <?php echo $this->Form->create(array('url'=>array('controller' => 'pages', 'action' => 'edit',$this->data['Page']['id'], 'admin'=>true),'type' => 'file','class'=>'addEdit')); ?>
               <?php  echo $this->Form->hidden('Page.id',array('label'=>false));   ?>
...
<div id="main">
	...
	<div class="box">
		<!-- Box Head -->
		<div class="box-head">
		  <h2 class="left">Edit <?php echo $this->data['Page']['name'];?></h2>
		...
		<!-- End Box Head -->
		<?php echo $this->Form->create(array('url'=>array('controller' => 'pages', 'action' => 'edit',$this->data['Page']['id'], 'admin'=>true),'type' => 'file','class'=>'addEdit')); ?>
		<?php  echo $this->Form->input('id',array('label'=>false,'type'=>'hidden', 'class'=>"field size4" ));   ?>
		...
		<div class="form">
			<div class="form-content contact-us">
				...
				<div class="row">
				  ...
				  <?php  echo $this->Form->input('status', array('label'=>false, 'options' => array('0' =>'Inactive', '1' => 'Active'), 'class'=>"field size4"));  ?>
				</div>
