...
<?php
        ...
        echo $this->Html->css(
                array(
					...
					'/admin_inner/plugins/iCheck/minimal/_all',
                    '/admin_inner/plugins/iCheck/flat/blue',
					'/admin_inner/plugins/iCheck/flat/_all',
...
<script type="text/javascript" >
	$(function() { 
		// SHOW A TOOLTIP ON ELEMENT, IF NOT EXISTS IN DATABASE, IT WILL CREATED AUTOMATICALLY
