  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
		...
		<a class="navbar-brand <?php echo $logo; ?>" style="<?php echo $cursor; ?>" href="<?php echo $logolink;?>">
      ...
      <div id="navbar-main" class="navbar-collapse collapse navbar-right">
        <ul class="nav navbar-nav">
			...
			<?php   if( $_SERVER['SERVER_NAME'] == 'www.ideascast.com' || $_SERVER['SERVER_NAME'] == LOCALIP && MAINTENANCE <= 0 ) { ?>
		  ...
		  <?php endif; */ ?>
			...
			?>
			  ...
			  <?php }  else{ ?>
			    ...
			    <li class="dropdown user user-menu">
				 <a href="<?php echo $this->Html->url( SITEURL.'users/login', true ); ?>">
				 <?php   if( $_SERVER['SERVER_NAME'] == 'www.ideascast.com' || $_SERVER['SERVER_NAME'] == LOCALIP && MAINTENANCE <= 0 ) { ?>
				 Account
				<?php }else{
