...
<!-- POPUP MODEL BOX CONTENT HEADER -->
	<div class="modal-header">
		...
		<h3 class="modal-title" id="createModelLabel">Task Management</h3>
	...
	<div class="modal-body elements-list">
		...
		<ul class="nav nav-tabs elements-tabs">
			...
			<li class="<?php if( $signoff_status >= 0 && isset($signoff_details['SignoffTask']['task_comment']) && !empty($signoff_details['SignoffTask']['task_comment']) ){ echo ''; } else { echo "disabledli"; } ?>">
						  ...
						  ?></span></div>
							<div class="depend-table" >
								<!--<table class="table table-striped" style=" ">-->
				                    <div class="dependency-row-body">
				                    	<div class="dependency-row dependency-row-bg">
					                      <div class="d-col d-col1 dependency-heading" >Title</div>
					                      <div class="d-col d-col2 dependency-heading" >Priority</div>
					                      <div class="d-col d-col3 dependency-heading" style="<?php echo ( GATE_ENABLED == true ) ? "" : "" ?>">Start</div>
					                      <div class="d-col d-col4 dependency-heading" style="<?php echo ( GATE_ENABLED == true ) ? "" : "" ?>">End</div>
					                      <div class="d-col d-col5 dependency-heading" style="<?php echo ( GATE_ENABLED == true ) ? "" : "" ?>">Dependencies</div>
										  <?php if( GATE_ENABLED == true ){ ?>
					                      <div class="d-col d-col6 dependency-heading" style="width: 5%;">Gate</div>
										  <?php } ?>
					                    </div>
					                   <?php									    
									   ...
									   <div class="dependency-row">
					                      <div  class="d-col d-col1" style="text-align: left;">
										  ...
										  <div class="d-col d-col2" style="text-align: center;">
					                      ...
					                      <div style="text-align: center;" class="d-col d-col5 elementChanger">
					                      </div>
										  <?php if( GATE_ENABLED == true ){ ?>
										  <div class="d-col d-col6" style="text-align: center;">
					                      	&nbsp;
					                      </div>
										  <?php } ?>
					                    </div>
	...
	<div class="modal-footer">
		 <button type="button" id="dependency_submit_update" data-btntype="update" class="btn btn-success submit_dependency <?php echo $ele_disabled ;?>">Update</button>

		 <button type="button" id="dependency_submit"  data-btntype="save"  class="btn btn-success submit_dependency <?php echo $ele_disabled ;?>">Save</button>
		 <button type="button" id="other_submit"  class="btn btn-success submit_element submitted <?php echo $ele_disabled ;?>">Save</button>
		 <button type="button" class="btn btn-danger" id="cancel_button" data-dismiss="modal">Close</button>
	</div>
