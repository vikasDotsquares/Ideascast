...
<span class="style-popple-icon">
								...
								<?php } else { ?>
									...
									<?php /*<a data-target="#modal_small" data-toggle="modal" data-remote="<?php echo Router::Url( array( 'controller' => 'shares', 'action' => 'show_profile', $userid, 'admin' => FALSE ), TRUE ); ?>" class="pophover" data-content="<div><p class='pop_username'><?php echo $user_name; ?></p><p><?php echo htmlentities($job_title); ?></p><?php echo $html; ?></div>">
                                        ...
                                        <div class="task-sh-remindar">
											...
											if( !empty($get_element_reminder['rem_userid']) && !empty($get_element_reminder['rem_elementid'] ) ) {
											 ...
											 ?>
                                              ...
                                              <?php } else if( $element_status == 'overdue' && !empty($elid['Reminder']['rem_id']) ){ 
												$reminder_html = '';
