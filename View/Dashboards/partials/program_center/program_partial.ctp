	...
	<div class="panel-heading program-search-heading" style="position: relative;">
		  <h3 class="panel-title">PROGRAMS (<?php echo (isset($program_data) && !empty($program_data)) ? count($program_data) : 0; ?>)</h3>
      ...
      <div class="panel panel-default SearchTerm">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a class="accordion-anchor" data-toggle="collapse"  data-parent="#accordion" href="#collapse<?php echo $program['id']; ?>" aria-expanded="false">
                <span class="program-title"><?php echo $program['program_name']; ?> (<span><?php echo (isset($program_projects) && !empty($program_projects)) ? count($program_projects) : 0; ?></span>)</span>
                  ...
                  <span class="show-hide-program btn btn-xs btn-white tipText" title="Show Project Cards">
                      <i class="fa"></i>
                  </span>
            </a>
          </h4>
            ...
            <div class="inner-horizontal" style="display: inline-block;">
              ...
              if( isset($program_projects) && !empty($program_projects) ) {
                ...
                //
                    ...
                    $rag_status = $this->Common->getRAG($key, true)['rag_color'];
                    if(isset($post_rag) && !empty($post_rag)) {
                        if($rag_status == $post_rag){
                            $project_details[$key]['rag_percent'] = $rag_status;
                        }
                    }
                    else{
                        $project_details[$key]['rag_percent'] = $rag_status;
