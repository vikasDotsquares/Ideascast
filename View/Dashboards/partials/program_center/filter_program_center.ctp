...
$counter = 0;
//$new_counter = (isset($programs) && !empty($programs)) ? count($programs) : 0;
...
// pr($program_data);
$program_data_tot = (isset($program_data) && !empty($program_data)) ? count($program_data) : 0;
if(isset($program_data) && !empty($program_data)){
?>
<div class="panel panel-default">
    <div class="panel-heading program-search-heading" style="position: relative;">
        <h3 class="panel-title">PROGRAMS (<span class="total-programs"><?php echo $program_data_tot; ?></span>)</h3>
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a class="accordion-anchor">
									...
									<div class="right-options">
                                        <span class="ico-nudge ico-program-center tipText disabled-nudge"></span>
...
<script type="text/javascript">
    $(function() {
		...
		$('.no-project-cards').attr('disable', true);
