			...
			<div id="collapse1" class="panel-collapse collapse in">
				...
				<div class="api-tyle-select-one">
					<label class="custom-dropdown" style="width:100%;">
						<select class="form-control aqua" name="api_type" id="api_type">							
							...
							<option value="element">Element API (Export)</option>
							...
							<option value="create_element">Create Element API (Import)</option>
				...
				<div class="elementapi" id="element_api" >
					...
					<div class="api-tyle-select-two" id="element_api_elelist" >
						<label class="custom-dropdown" style="width:100%;">
							<select class="form-control aqua" name="api_elements" id="api_elements">
				...
				<div class="createriskapi" id="create_risk_api" >
					...
					<div class="api-tyle-select-two" id="create_risk_api_elelist">
						<label class="custom-dropdown" style="width:100%;">						
							...
							<span class="loader-icon fa fa-spinner fa-pulse" style="display: none;"></span>
							<a data-content="Optional, if you want to relate risk to an Element." title="" data-trigger="hover" data-toggle="popover" role="button" class="btn  toltipover" data-placement="top" tabindex="0" data-original-title="" style="position: absolute; right: -44px; top: 0;"><i class="fa fa-info fa-3 martop"></i></a>
						</label>
					</div>
