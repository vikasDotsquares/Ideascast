...
<div class="row">
    ...
    <div class="col-xs-12">
        ...
        <div class="box-content wiki">
            ...
            <div class="row ">
                <div class="col-xs-12">
                    <?php echo $this->Form->create('ProjectSketch',array("url"=>array("controller"=>"skts","action"=>"edit","project_id"=>$project_id,"sketch_id"=>$sketch_id),array("class"=>"sketch_form")));
                    ?>
                            ...
                            <div class="panel-body" style="padding:0 15px 0 30px;">
                                <div class="form-group">
                                    ...
                                    <div class="pull-right">
                                        <button type="submit" id="save_sketch_data_pro" class="btn btn-success btn-sm">Update</button>
                                    ...
                                    <div class="idea-canvas-outerd list-group-itemd">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-sm-12"> 
												...
												<?php echo $this->Form->input('ProjectSketch.sketch_description',array('type'=>"text", 'id'=>"sketch_description", "value"=>$dsc, "class"=>"form-control input-small", "placeholder"=>"Max chars allowed 250","label"=>false,"div"=>false));?>
