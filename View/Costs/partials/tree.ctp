...
<?php
    ...
    // pr($wspend_sum);
?>
<?php /* ?><div class="header-sec-main" id="project_cost_header">
    <div class="header-sec-main-bg">
        <div class="select-fild">
            <div class="form-group">
                <label>Budget:</label>
                <div class="input-group">
                    <span class="input-group-addon"><?php echo($currency_symbol) ?></span>
                    <input type="text" class="form-control" id="project_budget" data-project="<?php echo $project_id; ?>" value="<?php echo (isset($project_detail['budget']) && !empty($project_detail['budget'])) ? number_format($project_detail['budget'],2, '.', ',') : '0.00'; ?>">
                <i class="fa fa-check save-budget tipText" title="Save Budget"></i>
                </div>
            </div>
            <div class="box-tools pull-right radio-family-left-unq">
                <div class="search_div pull-right">

                    <div id="sidetreecontrol" class="pull-left">
                        <a class="btn btn-primary btn-sm  searchbtn collp pull-right tipText" title="Collapse" href="?#" style="margin: 0 0 0 5px;"><i class="fa fa-compress"></i></a>
...
<div id="list_grid_containers" class="list_grid_containers_tree">
    <div class="tree-heading-wrap">
        ...
        <div class="heading-right-sec">
			<div class="col-sm-6">
            <span class="title-heading estimates-tital">Budget</span> </div>
          <div class="col-sm-6">  <span class="title-heading spending-tital">Actual</span></div>
        </div>
    </div>
            ...
            <span class="folder">
               <span class="left-sec">
                ...
                <span class="prj date-text">
					...
					echo($prj_start_date); ?> <i class="fas fa-long-arrow-alt-right"></i> <?php echo($prj_end_date);
					}
					?>
                </span>
            </span>
                ...
                <li class="closed wsp" >
                    <span class="folder">
                        ...
                        <span class="wsp date-text">
							...
							echo($wsp_start_date); ?> <i class="fas fa-long-arrow-alt-right"></i> <?php echo($wsp_end_date);
							}
							?>
                        </span></span>
                        ...
                        <li class="closed" >
                            ...
                            <span class="file">
                                ...
                                <span  class="elm date-text ">
									...
									echo($elm_start_date); ?> <i class="fas fa-long-arrow-alt-right"></i> <?php echo($elm_end_date);
									}
									?>
                                </span></span>
                            </span>
