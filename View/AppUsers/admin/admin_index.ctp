				...
				<div class="box">
					<div class="box-header">
						...
						<div class="pull-right padright">
							...
							<a class="btn btn-primary" href="<?php echo SITEURL; ?>sitepanel/app_users/add"> Add API User</a>
									...
									<div class="modal-body">
										<div class="form-group">
											...
											<div class="col-lg-12" style="text-align:right;margin:20px 0 0 0">
												...
												<a class="btn btn-primary searchbtn" href="<?php echo SITEURL; ?>sitepanel/app_users/user_resetfilter" >Close</a>
											</div>												
										</div>
									</div>
									</form>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<?php 
											$editURL = SITEURL."sitepanel/app_users/edit/".$user['AppUser']['id']; 
										?>
										...
										<?php 
										$deleteURL = SITEURL."sitepanel/app_users/delete/".$user['AppUser']['id']; 
										?>
...
$(document).on('click', '.RecordDeleteClass', function(){
	...
	$('#RecordDeleteForm').attr('action', '<?php echo SITEURL; ?>sitepanel/app_users/delete');
});
...
$(document).on('click', '.RecordUpdateClass', function(){
	id = $(this).attr('id');
	rel = $(this).attr('rel');
	$('#RecordStatusFormId').attr('action', '<?php echo SITEURL; ?>sitepanel/app_users/user_updatestatus');
	$('#recordID').val(id);
	if(rel == 'activate'){
		$('#recordStatus').val(1);
	}else{
...
$(document).on('click', '.WebExecutionRecordUpdateClass', function(){
	id = $(this).attr('id');
	rel = $(this).attr('rel');
	$('#WebExecutionFormId').attr('action', '<?php echo SITEURL; ?>sitepanel/app_users/update_web_permission');
