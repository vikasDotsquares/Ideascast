...
<?php
	...
	echo $this->Form->create('BlogComment', array('url' => array('controller' => 'team_talks', 'action' => 'add_comment_blog' ), 'class' => 'form-bordered', 'id' => 'BlogComment', 'data-async' => "", 'enctype'=>'multipart/form-data'));
?>
...
<div class="modal-body">
	...
	if((isset($this->params['named']['refer_id']) && !empty($this->params['named']['refer_id'])) || ((isset($refer_id) && !empty($refer_id))) ){
		$refer_id = ( isset($this->params['named']['refer_id']) && !empty($this->params['named']['refer_id']) ) ? $this->params['named']['refer_id'] : $refer_id;
		echo $this->Form->input('BlogComment.refer_id', [ 'type' => 'hidden', 'class' => 'form-control', 'value'=>$refer_id , 'div' => false, 'label' => false ] );
	}

	?>
	<div class="form-group">
		<label for="comments" >Description:</label>
		<?php echo $this->Form->textarea('BlogComment.description', [ 'type' => 'text', 'class' => 'form-control', 'required'=>true, 'div' => false, 'id' => 'title', 'escape' => true, 'placeholder' => 'max chars allowed 1000','rows'=>5, 'label' => false,'style'=>'resize:vertical;' ] );   ?>
...
<div class="modal-footer">
	<button type="button"  class="btn btn-success submit_blog_comment">Save</button>
