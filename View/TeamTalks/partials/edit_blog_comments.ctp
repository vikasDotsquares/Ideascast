...
<?php
	echo $this->Form->create('BlogComment', array('url' => array('controller' => 'team_talks', 'action' => 'edit_blog_comments' ), 'class' => 'form-bordered', 'id' => 'BlogComment', 'data-async' => "", 'enctype'=>'multipart/form-data'));
?>
...
<div class="modal-footer">
	<button type="button"  class="btn btn-success submit_blog_edit_comments">Update</button>
