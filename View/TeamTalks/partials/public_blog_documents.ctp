...
<?php
	...
	echo $this->Form->create('BlogDocument', array('url' => array('controller' => 'team_talks', 'action' => 'save_public_uploads' ), 'class' => 'form-bordered', 'id' => 'blogDocuments', 'data-async' => "", 'method'=>"POST", 'enctype'=>'multipart/form-data'));

?>
<!-- POPUP MODEL BOX CONTENT HEADER -->
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	<h3 class="modal-title" id="createModelLabel">Add Documents</h3>
</div>
    ...
    <div class="form-group ">
        ...
        <div class="input-group">
            ...
            <span title="" class="docUpload icon_btn bg-white border-radius-right tipText" data-original-title="Click to upload multiple files">
                <?php
					echo $this->Form->input('BlogDocument.document_name.', ['value' => '', 'type' => 'file', 'label' => false, 'div' => false, 'required' => true, 'class' => 'form-control upload blog-uploads', 'id' => 'file_name', 'placeholder' => 'Upload Multiple Files', "multiple" => "multiple"]);
                ?>
                <span class="text-blue" id="upText">Upload Multiple Documents</span>


            </span>
			<span class="loader-icon fa fa-spinner fa-pulse upload-multiple-docs" style="display: none;  margin-right: 146px;"></span>
        </div>
			<span class="doc-error text-red" ></span>

        <ul class="list-group" id="comment_uploads_list"></ul>
    </div>
</div>
<!-- POPUP MODAL FOOTER -->
<div class="modal-footer">
	<button type="button"  class="btn btn-success submit_public_documents">Save</button>
