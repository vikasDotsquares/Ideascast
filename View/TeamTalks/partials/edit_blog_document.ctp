...
<?php
	echo $this->Form->create('BlogDocument', array('url' => array('controller' => 'team_talks', 'action' => 'edit_blog_document' ), 'class' => 'form-bordered', 'id' => 'BlogDocument', 'data-async' => "", 'enctype'=>'multipart/form-data'));
?>
<!-- POPUP MODEL BOX CONTENT HEADER -->
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	<h3 class="modal-title" id="createModelLabel">Edit Blog Document</h3>
</div>
<!-- POPUP MODAL BODY -->
...
<div class="modal-footer">
	<button type="button"  class="btn btn-success submit_doc_comments">Update</button>
