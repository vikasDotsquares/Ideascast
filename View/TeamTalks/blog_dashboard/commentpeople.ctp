...
?>
	<div class="modal-header"> 
		<h3 id="modalTitle" class="modal-title" >Commented on this Blog</h3> 	
	</div>
	<div class="modal-body clearfix people">
		
			<?php foreach( $viewUsers as $key => $listUsers ) { 
				$val = $listUsers['BlogComment'];
				...
				<div class="row">
					...
					<div class="noavailwith">
						<img class="myaccountPic noavailwiths" alt="Logo Image" style="width: 80%"  src="<?php echo $profilesPic ?>" alt="Profile Image" />
