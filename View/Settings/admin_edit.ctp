	...
	<div class="panel panel-primary">
	  <div class="panel-heading">
         <h3 class="panel-title">
            Update Settings
           <!-- <a class="btn btn-warning btn-xs pull-right" href="<?php echo SITEURL ?>sitepanel">Back</a></h3>-->
      </div>
		<div class="panel-body form-horizontal">
			...
			<?php echo $this->Form->create('Setting', array('type' => 'file', 'class' => 'form-horizontal form-bordered', 'id' => 'RecordFormedit')); ?>
			<?php echo $this->Form->input('Setting.id', array('type' => 'hidden', 'label' => false, 'div' => false, 'class' => 'form-control')); ?>
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
							  <label for="UserUser" class="col-lg-3 control-label">Company no:</label>
							  <div class="col-lg-8">
					...
					<div class="row">
						<div class="col-md-6">	
							<div class="form-group">
							  <label for="UserUser" class="col-lg-3 control-label">Company Address:</label>
							  <div class="col-lg-8">
								<?php echo $this->Form->input('Setting.address', array('type' => 'textarea', 'escape' => false,'label' => false, 'div' => false, 'class' => 'form-control ckeditor')); ?>
							  </div>
							  <div class="col-lg-1">
								<a tabindex="0" data-placement="top" class="btn btn-default toltipover" role="button" data-toggle="popover" data-trigger="hover" title="" data-content="Please enter value"><i class="fa fa-info-circle fa-3 martop"></i></a>
							  </div>					  
						...
						<div class="col-md-6">	
							<div class="form-group">
							  <label for="UserUser" class="col-lg-3 control-label">Copyright section:</label>
							  <div class="col-lg-8">
								<?php echo $this->Form->input('Setting.copy', array('type' => 'textarea', 'escape' => false,'label' => false, 'div' => false, 'class' => 'form-control ckeditor')); ?>
							  </div>
							  <div class="col-lg-1">
								<a tabindex="0" data-placement="top" class="btn btn-default toltipover" role="button" data-toggle="popover" data-trigger="hover" title="" data-content="Please enter value"><i class="fa fa-info-circle fa-3 martop"></i></a>
							  </div>					  
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
							  <label for="UserUser" class="col-lg-3 control-label">Version:</label>
							  <div class="col-lg-8">
								<?php echo $this->Form->input('Setting.idesversion', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control')); ?>
								
							  </div>
							  <div class="col-lg-1">
								<a tabindex="0" data-placement="top" class="btn btn-default toltipover" role="button" data-toggle="popover" data-trigger="hover" title="" data-content="Please enter ideasCast version"><i class="fa fa-info-circle fa-3 martop"></i></a>
							  </div>					  
							</div>
						</div>					
				...
				<div class="modal-footer clearfix">
					...
					<button type="submit" class="btn btn-success"><!--<i class="fa fa-fw fa-check"></i>--> Save</button>
					 <a class="btn btn-danger" href="<?php echo SITEURL ?>sitepanel">Close</a>
