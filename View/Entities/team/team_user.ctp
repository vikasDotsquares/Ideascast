...
<?php
		...
		if(isset($effort_bar_blue_percentage) && !empty($effort_bar_blue_percentage)){
			...
			$remaining_color_tip_blue = "0 Hrs Completed of $effort_bar_total_hours_text Total (0%)";
		}
...
?>
	...
	<div class="ps-col tm-col-6">
		...
		<div class="team-date">
			<?php echo (!empty($activity['updated'])) ? $this->Wiki->_displayDate( date('Y-m-d H:i',strtotime($activity['updated'])), 'd M, Y') : ''; ?>
		</div>
	</div>
