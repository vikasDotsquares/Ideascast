...
$per_page_show = $this->Session->read('TemplateRelation.per_page_show');
$template_relation_id = $this->Session->read('TemplateRelation.template_relation_id');
?>
<style>
                ...
                <div class="col-xs-12">
					<div class="box">
                        ...
                        <div class="box-header" style="background: rgb(239, 239, 239) none repeat scroll 0px 0px; cursor: move; border-bottom: none; border: 1px solid #dddddd; padding: 8px 10px;">
							<?php echo $this->Form->create('templates', array("controller" => "templates", "url" => "jeera_dashboard", "method" => "post")); ?>
                            <div class="col-lg-12 no-padding project-board-top">
                                ...
                                <div class="col-sm-6 col-md-5 col-lg-4">
                                    ...
                                    <label class="custom-dropdown" style="width:100%">
                                        ...
                                        echo $this->Form->input('TemplateRelation.template_relation_id', array(
                                            'empty' => 'Select Folder',
                                            'type' => 'select',
                                            'options' => $options,
                                ...
                                <div class="col-sm-6 col-md-7 col-lg-8 text-right">
									...
									<a class="btn btn-danger btn-sm" href="<?php echo SITEURL; ?>templates/jeera_dashboard_resetfilter" >Reset</a>
					...
					<div class="box-body" id="box_body">
						<div class="template-dashboard table-responsive">
							<table class="table table-bordered table-hover" data-id="">
								...
								?>
									<tr id="rowid<?php echo $val['TemplateRelation']['id']; ?>" >
										...
										<td width="5%" align="center"><?php
											...
											$deleteURL = SITEURL."templates/delete_template/".$val['TemplateRelation']['id'];
											?>
									...
									<?php
										...
										<tr>
											...
											<ul class="pagination">
												<?php
												//pr($this->params['paging']['TemplateRelation']);
								...
								<?php } else { ?>
									<tr>
											<td colspan="6" align="center">No OpusView Template Found</td>
									</tr>
								<?php } ?>
								</tbody>
							</table>
...
if(isset($refer_url) && !empty($refer_url))
{

	//if($refer_url != $_SERVER[])
	//$_SESSION['last'] = $refer_url;
