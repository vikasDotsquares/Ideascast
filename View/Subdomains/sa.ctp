...
<div class="row">
                ...
                <div class="col-xs-12">
                    <div class="box noborder margin-top">
                        ...
                        <div class="box-body clearfix" style=" padding: 0; position: relative;" id="box_body">
                            ...
                            <div id="location_analyticsIframe" style="width: 100%; border: none; min-height: 715px; overflow: hidden; margin-top: 40px;"></div>

                            <div id="locationMenuPanel" class="menuGroup">
                                <input type="date" id="markerDate" class="markerDate" name="marker-date" title="Set Date Marker" onchange="setMarker();">
                                <button id="sortChrono" class="sortChrono" title="Sort Chronologically" onclick="sortChrono();"><img class="sortChronoImg" src="../images/icons/sort-chrono-white-18x18.png" /></button>
                                        <button id="sortAlpha" class="sortAlpha" title="Sort Alphabetically" onclick="sortAlpha();"><img class="sortAlphaImg" src="../images/icons/sort-alpha-white-18x18.png" /></button>
                                        <button id="expandButton" class="expandButton" title="Expand" onclick="expandHeight();"><img class="expandImg" src="../images/icons/expand-white-18x18.png" /></button>
                            </div>
    ...
    <script>
        ...
        $('#loc_selection_list').change(function(){
            ...
            if(data_section < 1){
                $("#menuPanel").hide();
                $('#location_analyticsIframe').html('<div class="col-sm-12 partial_data box-borders " style="padding: 10px;"><div class="col-sm-12 box-borders select-project-sec"><div class="no-data">SELECT VIEW</div></div></div></div>');
                return;
            }
            //load the data
            ...
            // d3.json("location.json").then(function (data) {
                ...
                myChart = TimelinesChart()
                    .data(data)
                    .maxHeight(document.getElementById('location_analyticsIframe').clientHeight) //set to height of location_analyticsIframe
        ...
        function showUserProfileOrProject(labelName, activityGroup) {
            ...
            if (found && foundType === "Username") {
                ...
                window.open("https://companydemo.opusviewdev.com/projects/index/" + project_id, "_self");
            }
        }
        ...
        function setMarker() {
            ...
            setTimeout(() => {
                ...
                if (atClient === 0) {
                    ...
                    document.getElementById('atClientBar').style.width = format(atClient / totalPeople);
