...
if (isset($projects) && !empty($projects)) {
	foreach ($projects as $key => $value) {
		...
		if($roleCurrent=='Group Owner'){
			$roleCurrent = 'Owner';
		}

		if($roleCurrent=='Group Sharer'){
			$roleCurrent = 'Sharer';
		}
		//pr($value['wlevel']);
...
?>
<div class="ps-data-row" data-project="<?php echo $project_id; ?>">
	<div class="ps-col ps-col-1">
		<div class="opp-project-details">
			...
			<div class="opp-project-middle">
				<a class="opp-project-name" href="<?php //echo Router::url(['controller' => 'projects', 'action' => 'index', $project_id, 'admin' => FALSE], TRUE) ?>" data-remote="<?php echo Router::Url( array( 'controller' => 'projects', 'action' => 'view_project', $project_id, 'admin' => FALSE ), TRUE ); ?>" data-toggle="modal" data-target="#modal_view_program"><?php echo htmlentities($project['ptitle'], ENT_QUOTES, "UTF-8"); ?></a>
