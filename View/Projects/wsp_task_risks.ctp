...
<div class="modal-header">
    ...
    <h3 class="modal-title">Risks in Workspace </h3>
</div>
			...
			<div class="panel panel-default list-panel">
				<div class="panel-heading">
					<h4 class="panel-title">
						...
						<a class="exclamation-icon" href="<?php echo SITEURL;?>risks/index/<?php echo $project_id; ?>/risk:<?php echo $rmdetail_id['RmElement']['rm_detail_id']; ?>"><i class="fa fa-exclamation" aria-hidden="true"></i></a>
						<!-- <a class="exclamation-icon" href="<?php echo SITEURL;?>risks/index/<?php echo $project_id; ?>"><i class="fa fa-exclamation" aria-hidden="true"></i></a> -->
						<span class="risks-ellipsis"><?php echo htmlentities($rm_details['RmDetail']['title'],ENT_QUOTES, "UTF-8");?></span>
							...
							<div class="row work-project-info-mainrow">
								<div class="work-project-info-col col-md-12">
										...
										<div class="col-md-3 nopadding-right">
											<div class="risk-assigned-user"><span>Assignees:</span>
												<?php
													...
													$assigneesUser = '';
													$risk_leader = risk_leader($rmdetail_ids);
													// pr($risk_leader);
													if( isset($riskUsers) && !empty($riskUsers) ){
														foreach($riskUsers as $ulist){
															$icon = '';
															if($risk_leader){
																if(in_array($ulist, $risk_leader)){
																	$icon = "<i class='fa fa-check text-blue' style='margin-left: 5px;'></i>";
																}
															}
															$ulistfullname = $this->Common->userFullname($ulist);
															$assigneesUser .="<div>".$ulistfullname.$icon."</div>";
														}
													}
												?>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="risk-elements"><span>Related Tasks:</span>
												<ul>
												<?php
													$riskElements = $this->ViewModel->wsp_permission_risk_element($project_id,$workspace_id, $rm_details['RmDetail']['id']);
