    ...
    <div class="list-form border bg-warning nopadding">
        ...
        <div class="see-activity-list">
         <div id="task-activity" class="panel-collapse collapse history_update_new  table-rows">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group activt" style="margin:5px 0 0 0;">
                            ...
                            <div style="display:inline-block;">
                                <?php //pr($this->params);?>
                                <a id="<?php echo ucfirst($project_id); ?>" itemid="update-filter-<?php echo ucfirst($project_id); ?>" itemtype="element_tasks" href="javascript:void(0);" class="btn btn-sm btn-success filter-history-btn">
                                    Filter
                                </a>
                            </div>
                        </div>
            ...
            <?php
            $history_lists = $this->requestAction(array("controller"=>"projects","action"=>"get_history" ,$project_id));
            ?>
            <div class="row scrolling-history table-responsive hmgo " id="update-filter-<?php echo ucfirst($project_id); ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //$("body").delegate(".remove_history", "click", function (event) {
            ...
            var $row = $(this);
            var urlV = $js_config.base_url + "projects/get_filter_history/id:" + id + "/seeactivityhistory:" + seeactivityhistory;
