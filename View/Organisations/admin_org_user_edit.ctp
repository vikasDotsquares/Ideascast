	...
	<div class="panel panel-primary">
	  <div class="panel-heading">
         <h3 class="panel-title">
			...
			<?php
					if(isset($this->request->params['pass']['1']) && !empty($this->request->params['pass']['1'])){
						 $url =  SITEURL."sitepanel/organisations/orgusers/".$this->request->params['pass']['1'];
					}else{
						 $url =  SITEURL."sitepanel/organisations";
					} ?>
		...
		<div class="panel-body form-horizontal">
			...
			<?php echo $this->Form->create('User', array( 'url' => array('controller'=>'organisations', 'action'=>'org_user_edit'),'type' => 'file', 'class' => 'form-horizontal form-bordered', 'id' => 'RecordFormedit')); ?>
				...
				<?php echo $this->Form->input('User.org_id', array('type' => 'hidden', 'label' => false, 'div' => false, 'class' => 'form-control', 'value'=>$this->request->params['pass']['1'])); ?>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
							  ...
							  <div class="col-lg-8">
								<?php echo $this->Form->input('User.email', array('type' => 'text','label' => false, 'div' => false, 'class' => 'form-control','disabled'=>'disabled')); ?>
							  </div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-8">
									<p></p>
									<img src="<?php echo $docimgs ?>" class="img-responsive img-circle" alt="Profile Image" />
								</div>								
							</div>
				...
				<div class="modal-footer clearfix">
					...
					?><a class="btn btn-danger" href="<?php echo $url; ?>">Close</a>
				</div>
			</form>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
