...
// Adding Text element with font customized using named font style
    ...
    $phpWord->addFontStyle($fontStyleName, array('name' => 'Tahoma', 'size' => 10, 'color' => 'red', 'bold' => true) );
// Adding Text element with font customized using explicitly created font style object...
    ...
    $myTextElement = $section->addText(strip_tags($this->fetch('content')), array('name' => 'Calibri', 'size' => 18, 'color' => 'red'));
...
<?php // Below div is an overlay of body, while AJAX request is in progress.  ?>
        ...
        <div class="wrapper">
            ...
            <div class="section">
                ...
                <section class="details" style="text-align: center;  margin-right:auto;margin-left:auto; ">
                 <?php 
                 echo $this->fetch('content'); ?> 
                </section>
