...
?>
			...
			<div class="todocombutton_bottom ">
                               <!-- <a  href="javascript:void(0);" class="btn btn-xs btn-default tipText" title="Calendar">
                                ...
                                <a href="javascript:void(0);" class="btn btn-xs tipText btn-primary" title="Expand All" id="open">
					<i class="fa fa-expand"></i>
				</a>
                                <a href="javascript:void(0);" class="btn btn-xs tipText btn-primary " title="Collapse All" id="close">
					<i class="fa fa-compress"></i>
				</a>
                                <a href="<?php echo Router::Url(array("controller" => "todos", "action" => "manage", $do_list_id), true); ?>" data-id="<?php echo $do_list_id ?>" class="btn btn-xs todo-esd tipText btn-success <?php if(isset($data['DoList']['sign_off']) && !empty($data['DoList']['sign_off'])){ ?>disabled<?php } ?> tipText update_dolist" title="Edit">
					<i class="editwhite"></i>
				</a>

                                <button data-dotype="<?php echo $signoffmsg;?>" data-id="<?php echo $do_list_id ?>" title="Sign Off" class="btn btn-xs btn-success todo-esd tipText sign_off_dolist <?php if(isset($data['DoList']['sign_off']) && !empty($data['DoList']['sign_off'])){ ?>disabled<?php } ?>">
					<i class="signoffwhite"></i>
				</button>

                                <button title="Delete" data-dotype="<?php echo $signoffmsg;?>"  data-id="<?php echo $do_list_id ?>" class="btn btn-xs btn-danger tipText todo-esd delete_dolist">
					<i class="deletewhite"></i>
				</button>
                                <?php
