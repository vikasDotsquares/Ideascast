...
?>
<?php
echo $this->Form->create('WikiPage', array('url' => array('controller' => 'wikies', 'action' => 'update_wiki_page_save',$project_id,$user_id,$wiki_id,$wiki_page_id), 'class' => 'form-bordered'));
...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <?php echo $this->Form->textarea('WikiPage.descriptions', [ 'value'=>$this->request->data['WikiPage']['description'],'class' => 'form-control description description_limit', 'id' => 'description_update', 'escape' => true, 'rows' => 10, 'placeholder' => 'max chars allowed 500']); ?>
        <span class="error-message text-danger" ></span>
        <textarea id="txts_upage" name="data[WikiPage][description]" style="display:none;" class="description_limit"><?php echo $this->request->data['WikiPage']['description'];?></textarea>
        <!--<span class="title_error error-message text-danger" ></span>-->
    </div>
    <?php
...
<div class="modal-footer">
    <button type="submit" id="submitwikipageSaves" data-id="<?php echo $wiki_page_id; ?>" class="btn btn-success">Save</button>
...
<script type="text/javascript" >
    ...
    function updateDiv() {
        var editorText = CKEDITOR.instances.description_update.getData();
        $('#txts_upage').html(editorText);
    }
