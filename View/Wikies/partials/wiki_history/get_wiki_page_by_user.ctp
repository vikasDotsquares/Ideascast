            ...
            <div class="panel panel-default wiki-block page-collapse-<?php echo $wikipage['WikiPage']['id'] ?>">
                <div class="panel-heading bg-curious-Blue">
                    <h4 class="panel-title wiki-common-h4">
                        <a class="accordion-toggle openwikipage_history_anchor page-accordion collapsed" data-toggle="collapse" data-parent="#<?php echo $type;?>-page-accordion" href="#<?php echo $type;?>-page-collapse-<?php echo $wikipage['WikiPage']['id'] ?>">
<!--                            <i class="indicator fa "></i>-->
                ...
                <div id="<?php echo $type;?>-page-collapse-<?php echo $wikipage['WikiPage']['id'] ?>" class="panel-collapse page-accordion collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        $wikipageid = null;
                        if(isset($wikipage['WikiPage']['revision_id']) && $wikipage['WikiPage']['revision_id'] > 0){
                            $wikipageid = $wikipage['WikiPage']['revision_id'];
                        }else{
                            $wikipageid = $wikipage['WikiPage']['id'];
                        }
                        ?>

                        <a title="Show Wiki Pages" data-remote="<?php echo SITEURL;?>wikies/get_updated_pages/<?php echo $project_id;?>/<?php echo $this->Session->read("Auth.User.id");?>/<?php echo $wiki_id?>/<?php echo $wikipageid;?>" data-id="<?php echo $wikipage['WikiPage']['id'];?>" class="getupdatedpage btn btn-default btn-xs tipText" ><i class="fa fa-folder-open-o"></i></a>
                        ...
                        <div class="idea-wiki-bottom-sec">
                            ...
                            <div class="collapse" id="wiki_page_all_detail_<?php echo $wikipage['WikiPage']['id']; ?>">
                                <ul class="updateDetail">
                                    <li>Created:
                                        <?php
                                    echo (isset($wikipage['WikiPage']['created']) && !empty($wikipage['WikiPage']['created'])) ? $this->Wiki->_displayDate(date("Y-m-d h:i:s A",$wikipage['WikiPage']['created'])) : 'N/A';
                                        ?>
                                    </li>
                                    <li>Created by:
                                        <?php
                                    ...
                                    <li id="updatedtext-<?php echo $wikipage['WikiPage']['id'];?>">Updated:
                                        ...
                                        echo (isset($updated) && !empty($updated)) ? $this->Wiki->_displayDate(date("Y-m-d h:i:s A",$updated)) : 'N/A';
                                        ?>
                                    </li>
        ...
        ?>
        <div class="text-center "> No other pages <!--<a href="" class="backtoread" >  Back</a>--></div>
        <?php
    }
    ?>
</div>
