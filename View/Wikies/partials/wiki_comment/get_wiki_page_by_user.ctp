...
?>
<div class="panel-group" style="" id="<?php echo $type;?>-page-accordion-wiki">
    <?php
            ...
            <div class="panel panel-default wiki-block page-collapse-<?php echo $wikipage['WikiPage']['id'] ?>">
                <div class="panel-heading bg-curious-Blue">
                    <h4 class="panel-title wiki-common-h4">
                        <a class="accordion-toggle openwikipage_comment_anchor page-accordion collapsed"data-toggle="collapse" data-parent="#<?php echo $type;?>-page-accordion-wiki" href="#<?php echo $type;?>-page-collapse-<?php echo $wikipage['WikiPage']['id'] ?>">
                ...
                <div id="<?php echo $type;?>-page-collapse-<?php echo $wikipage['WikiPage']['id'] ?>" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        $commentparam = "wikies/get_wiki_page_comment/".$project_id."/".$this->Session->read('Auth.User.id')."/".$wiki_id."/".$wikipage['WikiPage']['id'];
                        ?>
                        <a title="Wiki Page Comments" data-remote="<?php echo SITEURL.$commentparam;?>" class="tipText btn btn-xs btn-default wikipagecomments"><i class="fa fa-comments"></i></a>
...
<script type="text/javascript" >
    $(function ($) {
        $("body").delegate(".openwikipage_comment_anchor", 'click', function (e) {
