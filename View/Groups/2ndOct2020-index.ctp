			...
			success: function (response) {
				if (response.success) {
					...
					if( selectValues != null ) {
						...
						var resArray = [];
						var resArray1 = [];
						$.each(selectValues,function(index, el) {
							var data = {sn: index, name: el};
							resArray1.push( data )
							if(chunks == i){
								i = 0;
								resArray.push(resArray1)
								var resArray1 = [];
							}
							i++;
						});*/
						...
						$('#user_text_search').append(output);
					...
					setTimeout(function(){
						$.user_text_search = $('#user_text_search').multiselect({
							enableUserIcon: true,
							maxHeight: '400',
							buttonWidth: '100%',
							buttonClass: 'btn btn-info',
							...
							onSelectAll: function() {
								var sel_users = $('#user_text_search option:selected');
								var selected = [];
						...
						$('#user_text_search').multiselect('rebuild') ;

						$.user_skill_search = $('#user_skill_search').multiselect({
							enableUserIcon: true,
							maxHeight: '400',
							buttonWidth: '100%',
							buttonClass: 'btn btn-info',
							...
							onSelectAll: function() {
								var sel_users = $('#user_skill_search option:selected');
								var selected = [];
								$(sel_users).each(function(index, brand){
									selected.push($(this).val());
								});
						...
						$('#user_skill_search').multiselect('rebuild') ;

						$.user_subject_search = $('#user_subject_search').multiselect({
							enableUserIcon: true,
							maxHeight: '400',
							buttonWidth: '100%',
							buttonClass: 'btn btn-info',
							...
							onSelectAll: function() {
								var sel_users = $('#user_subject_search option:selected');
								var selected = [];
								$(sel_users).each(function(index, brand){
									selected.push($(this).val());
								});
						...
						$('#user_subject_search').multiselect('rebuild') ;

						$.user_domain_search = $('#user_domain_search').multiselect({
							enableUserIcon: true,
							maxHeight: '400',
							buttonWidth: '100%',
							buttonClass: 'btn btn-info',
							...
							onSelectAll: function() {
								var sel_users = $('#user_domain_search option:selected');
								var selected = [];
								$(sel_users).each(function(index, brand){
									selected.push($(this).val());
								});
						...
						$('#user_domain_search').multiselect('rebuild') ;

						$.user_tag_search = $('#user_tag_search').multiselect({
							enableUserIcon: true,
							maxHeight: '400',
							buttonWidth: '100%',
							buttonClass: 'btn btn-info',
							...
							onSelectAll: function() {
								var sel_users = $('#user_tag_search option:selected');
								var selected = [];
								$(sel_users).each(function(index, brand){
									selected.push($(this).val());
								});
						...
						$('#user_tag_search').multiselect('rebuild') ;
				...
				if(response.success){
					if(type == 'tag') {
						...
						if(response.content.length > 0) {
							...
							queryArr = $.sort_data(queryArr);console.log(queryArr);
						}
						$.user_tag_search.multiselect('dataprovider', queryArr);
						$.tag_search_users = [];
					}
					if(type == 'skill') {
						$.user_skill_search.multiselect('deselectAll', false);
						var queryArr = [];
						console.log($.availableAllUsers);
							console.log(response.content);
						if(response.content.length > 0) {
						...
						$.user_skill_search.multiselect('dataprovider', queryArr);
						$.skill_search_users = [];
					}
					if(type == 'subject') {
	...
	<div class="col-xs-12">
												...
												<div class="tab-content" id="myTabContent">
													<div id="text_search" class="tab-pane fade active in">
														...
														<div class="create-group-rows">
															...
															<div class="create-group-input-col">
																<select id="user_text_search" multiple="multiple"> </select>
													...
													<div id="tag_search" class="tab-pane fade">
														<div class="row">
															...
															<div class="create-group-rows col-sm-12">
																...
																<div class="create-group-input-col">
																	<select id="user_tag_search" multiple="multiple"> </select>
																	<span class="error-message group-user-err error text-danger"></span>
																</div>
															</div>
														</div>
													...
													<div id="skills_search" class="tab-pane fade">
														<div class="row">
															...
															<div class="create-group-rows col-sm-12">
																<div class="create-group-title"><label class="input-label" for="RiskType">Group Members: </label></div>
																<div class="create-group-input-col">
																	<select id="user_skill_search" multiple="multiple"> </select>
																	<span class="error-message group-user-err error text-danger"></span>
																</div>
															</div>
														</div>
													...
													<div id="subjects_search" class="tab-pane fade">
														<div class="row">
															...
															<div class="create-group-rows col-sm-12">
																<div class="create-group-title"><label class="input-label" for="RiskType">Group Members: </label></div>
																<div class="create-group-input-col">
																	<select id="user_subject_search" multiple="multiple"> </select>
																	<span class="error-message group-user-err error text-danger"></span>
																</div>
															</div>
														</div>
													...
													<div id="domains_search" class="tab-pane fade">
														<div class="row">
															...
															<div class="create-group-rows col-sm-12">
																<div class="create-group-title"><label class="input-label" for="RiskType">Group Members: </label></div>
																<div class="create-group-input-col">
																	<select id="user_domain_search" multiple="multiple"> </select>
																	<span class="error-message group-user-err error text-danger"></span>
																</div>
															</div>
														</div>
		...
		$(function(){
			$.sel_tags_group = $('#sel_tags_group').multiselect({
				...
				onSelectAll: function() {
					var sel_users = $('#sel_tags_group option:selected');console.log(sel_users);
					var selected = [];
					$(sel_users).each(function(index, brand){
						selected.push([$(this).val()]);
					});
