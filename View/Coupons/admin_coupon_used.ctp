		...
		<div class="row">
			<div class="col-xs-12">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo SITEURL; ?>sitepanel/coupons"> Coupons</a></li>
					<li class="active">Transactions</li>
				</ol>
				<h3>Coupon: Transactions (<?php echo $count; ?>)<?php //echo $this->Common->couponName($this->params['pass']['0']); ?></h3>
				</div>
					...
					<div class="box-header">
						<h3 class="box-title">
							<small>Per Page Records</small> </h3>
								<div class="margintop">
									<div class="col-lg-1 ">
										<?php echo $this->Form->create('Coupon', array( 'url' => array('controller'=>'coupons', 'action'=>'coupon_used',$this->request->params['pass']['0']), 'type' => 'file', 'class' => 'form-horizontal form-bordered', 'id' => 'per_page_show_form' )); ?>
										<?php 
						...
						<div class="<?php echo $class; ?> search" id="collapseExample">
							<div class="well">
								<?php echo $this->Form->create('Coupon', array( 'url' => array('controller'=>'coupons', 'action'=>'coupon_used',$this->request->params['pass']['0']), 'type' => 'POST', 'class' => 'form-horizontal form-bordered', 'id' => 'search_page_show_form')); ?>
						...
						<table id="example2" class="table table-bordered table-hover">
							...
							<tbody>
								<?php
									...
									/*	foreach($coupon['UserTransctionDetail'] as $cou){ 
										
										//pr($cou);
											echo date(('m/d/Y'),$cou['payment_date']); echo "<br>";
										    echo $cou['mc_currency']." ".$cou['amount']; echo "<br>";
											echo $cou['User']['UserDetail']['first_name']." ".$cou['User']['UserDetail']['last_name']; echo "<br>";
										}
										*/
                                ?>
								<tr>
									...
									<td><?php //echo $coupon['User']['UserDetail']['first_name']." ".$coupon['UserDetail']['last_name']; ; ?>
									...
									<td><?php if(empty($coupon['UserTransctionDetail']['institution_id'])){ echo "N/A"; }else{ $det = $this->Common->userDetail($coupon['UserTransctionDetail']['institution_id']);  
