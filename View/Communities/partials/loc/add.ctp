			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
					  	...
					  	<div class="form-control-skill">
							<?php echo $this->Form->input('Location.name', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control', 'maxlength'=>50, 'autocomplete'=>'off')); ?>
					...
					<div class="form-group">
					  	...
					  	<div class="form-control-skill">
							<?php echo $this->Form->input('Location.information', array('type' => 'textarea', 'rows'=> 5, 'cols'=>35, 'label' => false, 'div' => false, 'class' => 'form-control information', 'maxlength'=>4096 )); ?>
							<label class="error text-red"></label>
				  		</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="form-group">
					  	...
					  	<div class="form-control-skill">
					  		<?php if(isset($countries) && !empty($countries)){ ?>
					  			...
					  			?>
					  				<option value="<?php echo $value['Country']['id']; ?>" data-code="<?php echo $value['Country']['countryCode']; ?>"><?php echo $value['Country']['countryName']; ?></option>
					  			<?php
					  			} ?>
					  			</select>
					  		<?php } ?>
					...
					<div class="form-group">
					  	...
					  	<div class="form-control-skill">
							<?php echo $this->Form->input('Location.address', array('type' => 'textarea', 'rows'=> 5, 'cols'=>35, 'label' => false, 'div' => false, 'class' => 'form-control' )); ?>
							<label class="error text-red"></label>
				  		</div>
					</div>
					<div class="form-group">
					  	...
					  	<div class="form-control-skill">
							<?php echo $this->Form->input('Location.city', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control', 'maxlength'=>50, 'autocomplete'=>'off')); ?>
							<label class="error text-red"></label>
				  		</div>
					</div>
					<div class="form-group">
