...
if (isset($workspaceData) && !empty($workspaceData)) { //pr($data);
    ...
    <div class="modal-header"> 
        <h3 id="modalTitle" class="modal-title" ><?php echo htmlentities($workspaceData['Workspace']['title']); ?><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></h3> 	
    </div>
