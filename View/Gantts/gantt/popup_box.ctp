                        ...
                        <ul class="list-unstyled text-center">
                            <li class="odue">
                                ...
                                <a href="<?php echo SITEURL;?>entities/update_element/<?php echo $elementData['Element']['id'];?>#tasks">
                                    <span data-original-title="<?php echo $t;?> Task Status" class="btn btn-xs bg-mix bg-navy tipText" title="" href="#"><i class="fa fa-exclamation"></i></span></a>
                            </li>                            
                            <li class="ico_links">
                                ...
                                <span data-original-title="Links" class="btn btn-xs bg-mix tipText bg-maroon" title="" href="#"><i class="fa fa-link"></i></span></a>
                            </li>
                            <li class="inote">
                            ...
                            <li class="green">
                                ...
                                <a href="<?php echo SITEURL;?>entities/update_element/<?php echo $elementData['Element']['id'];?>#mind_maps">
                                    <span data-original-title="Mind Maps" class="btn btn-xs bg-mix bg-green tipText" title="" href="#"><i class="fa fa-sitemap"></i></span></a>
                            </li>
                            <li class="orang">
                                ...
                                <a href="<?php echo SITEURL;?>entities/update_element/<?php echo $elementData['Element']['id'];?>#decisions">
                                    <span data-original-title="Decisions" class="btn btn-xs bg-mix bg-orange  tipText decisions" title="" href="#"><i class="fa fa-expand"></i></span></a>
                            </li>
                            <li class="l-blue">
                            ...
                            <li class="l-orang">
                                ...
                                <a href="<?php echo SITEURL;?>entities/update_element/<?php echo $elementData['Element']['id'];?>#votes">
                                    <span class="btn btn-xs bg-mix tipText bg-orange-active" title="" href="#" data-original-title="Votes"><i class="fa fa-inbox"></i></span></a>
                            </li>
                        </ul>  
                    </div>
