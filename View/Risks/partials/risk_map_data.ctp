...
<div class="projectrisk-top">
    <div class="projectrisk-button">
        <a class="reset_filter tipText" title="Reset" id="reset_filter"><i class="resetblack"></i></a>
		 <a class="tipText risk-detail" title="Risk Details" href="<?php echo Router::url(['controller' => 'risks', 'action' => 'index', 'admin' => false], true) ?>"><i class="listblack"></i></a>
        <a class="tipText" title="Add Risk" href="<?php echo Router::Url(['controller' => 'risks', 'action' => 'manage_risk', 'admin' => false], true); ?>"> <i class="workspace-icon"></i></a>
    </div>
</div>
<div class="projectrisk-outer">
...
<?php
if(isset($project_id) && !empty($project_id) && $project_id != 'all' && $project_id != 'my'){
    $url_project = $project_id;
}
if(isset($project_id) && !empty($project_id) && $project_id == 'all'){
    $url_project = 'project:all';
}
if(isset($project_id) && !empty($project_id) && $project_id == 'my'){
    $url_project = 'project:my';
}
?>
</div>
