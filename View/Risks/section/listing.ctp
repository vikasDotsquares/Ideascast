...
<div class="risks-data-row" data-id="<?php echo $risk_id; ?>">
    <div class="rs-col rs-col-1">
        <div class="risks-title-text">
            ...
            <?php } ?>
            <a href="<?php echo Router::url(array('controller' => 'projects', 'action' => 'index', $project_id )); ?>" class="risks-title-info tipText" title="Open Project" style="color: #777;"><?php echo htmlentities($ptitle, ENT_QUOTES, "UTF-8"); ?></a>
        </div>
    </div>
    ...
    <div class="rs-col rs-col-8">
        <div class="rs-flag-iocn">
            ...
            <?php
                ...
                if( $risk_creator_id == $current_user_id && $rd_status != 'Completed') $btn_status = '';
            ?>
            <a href="<?php echo Router::Url( array( "controller" => "risks", "action" => "manage_risk", $risk_id, 'admin' => FALSE ), true ); ?>" class="rs-show-h tipText <?php echo $btn_status; ?>" title="Edit"> <i class="edit-icon"></i>
            </a>
            <?php
            $del = '';
            ...
            ?>
            <a href="#" class="rs-show-h <?php echo $del; ?> tipText trash_risk delete-an-item" title="Delete" data-risk="<?php echo $risk_id; ?>" data-toggle="modal" data-target="#modal_delete" data-remote="<?php echo Router::Url( array( "controller" => "risks", "action" => "delete_an_item", $risk_id, 'admin' => FALSE ), true ); ?>"> <i class="deleteblack"></i>
            </a>
        </div>
    </div>
</div>
...
<?php } // if risks exists
    ...
    <div class="no-row-wrapper">No Risks</div>
<?php } ?>
